                        ...
                        <div class="offcanvas-top d-flex justify-content-between align-items-center mb-20">
                            <div class="offcanvas-logo">
                                <a class="logo-black" href="<?= base_url() ?>">
                                    <img src="<?= base_url() ?>images/bangunan/logo.png" alt="logo" style="max-height:55px;width:auto;">
                                </a>
                            </div>
                        ...
                        <div class="offcanvas-gallery d-none d-xl-block">
                            <div class="offcanvas-gallery-thumb-wrapper">
                                <div class="offcanvas-popup-thumb">
                                    <a class="popup-image" href="<?= base_url() ?>images/gallery/gallery-thumb-01.webp">
                                        <img src="<?= base_url() ?>images/gallery/gallery-thumb-01.webp" alt="image">
                                    </a>
                                </div>
                                <div class="offcanvas-popup-thumb">
                                    <a class="popup-image" href="<?= base_url() ?>images/gallery/gallery-thumb-02.webp">
                                        <img src="<?= base_url() ?>images/gallery/gallery-thumb-02.webp" alt="image">
                                    </a>
                                </div>
                                <div class="offcanvas-popup-thumb">
                                    <a class="popup-image" href="<?= base_url() ?>images/gallery/gallery-thumb-03.webp">
                                        <img src="<?= base_url() ?>images/gallery/gallery-thumb-03.webp" alt="image">
                                    </a>
                                </div>
                                <div class="offcanvas-popup-thumb">
                                    <a class="popup-image" href="<?= base_url() ?>images/gallery/gallery-thumb-04.webp">
                                        <img src="<?= base_url() ?>images/gallery/gallery-thumb-04.webp" alt="image">
                                    </a>
                                </div>
                                <div class="offcanvas-popup-thumb">
                                    <a class="popup-image" href="<?= base_url() ?>images/gallery/gallery-thumb-05.webp">
                                        <img src="<?= base_url() ?>images/gallery/gallery-thumb-05.webp" alt="image">
                                    </a>
                                </div>
                                <div class="offcanvas-popup-thumb">
                                    <a class="popup-image" href="<?= base_url() ?>images/gallery/gallery-thumb-06.webp">
