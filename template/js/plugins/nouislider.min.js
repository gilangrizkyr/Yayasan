!function(t, e) {
    ...
    function T(t, f, o) {
        var i, n, l, u, s, a, c = window.navigator.pointerEnabled ? {
            ...
            return t
        }(), d = t, S = f.spectrum, h = [], m = [], g = [], v = 0, b = {}, x = !1, y = t.ownerDocument, w = f.documentElement || y.documentElement, E = y.body, r = "rtl" === y.dir || 1 === f.ort ? 0 : 100;
        function P(t, e) {
        ...
        function C(t, e) {
            ...
            n.addEventListener("keydown", function(t) {
                return function(t, e) {
                    ...
                    return et(e, S.toStepping(u), !0, !0),
                    $("slide", e),
                    $("update", e),
                    $("change", e),
                    $("set", e),
        ...
        function D(d) {
            var h = function(t) {
                ...
                if (t.mode !== ut.PipsMode.Count)
                    return t.mode === ut.PipsMode.Positions ? U(t.values, t.stepped) : t.mode === ut.PipsMode.Values ? t.stepped ? t.values.map(function(t) {
            ...
            h.forEach(function(t, e) {
                var r, n, i, o, s, a, l, u, t = t, c = h[e + 1], p = d.mode === ut.PipsMode.Steps, f = (f = p ? S.xNumSteps[e] : f) || c - t;
                for (void 0 === c && (c = t),
                f = Math.max(f, 1e-7),
                r = t; r <= c; r = Number((r + f).toFixed(7))) {
                    ...
                    a = -1 < h.indexOf(r) ? ut.PipsType.LargeValue : p ? ut.PipsType.SmallValue : ut.PipsType.NoValue,
                    !e && g && r !== c && (a = 0),
        ...
        function O(i, o, s) {
            var t, a = y.createElement("div"), n = ((t = {})[ut.PipsType.None] = "",
            ...
            Object.keys(i).forEach(function(t) {
                ...
                r = i[e = t][0],
                n = i[t][1],
                (n = o ? o(r, n) : n) !== ut.PipsType.None && ((t = P(a, !1)).className = p(n, f.cssClasses.marker),
                t.style[f.style] = e + "%",
                n > ut.PipsType.NoValue && ((t = P(a, !1)).className = p(n, f.cssClasses.value),
        ...
        function _(t, e) {
            e.handle && (vt(e.handle, f.cssClasses.active),
            --v),
            e.listeners.forEach(function(t) {
                w.removeEventListener(t[0], t[1])
            }),
            0 === v && (vt(d, f.cssClasses.drag),
            tt(),
            t.cursor && (E.style.cursor = "",
        ...
        function B(t, e) {
            ...
            t.cursor && (E.style.cursor = getComputedStyle(t.target).cursor,
        ...
        function q(t) {
            ...
            s);
            !1 !== r && (f.events.snap || dt(d, f.cssClasses.tap, f.animationDuration),
            et(r, e, !0, !0),
            tt(),
            $("slide", r, !0),
            $("update", r, !0),
        ...
        function Y(a) {
            ...
            a.tap && z(c.start, i, q, {}),
            a.hover && z(c.move, i, X, {
                hover: !0
            }),
            a.drag && u.forEach(function(e, t) {
                var r, n, i, o, s;
                !1 !== e && 0 !== t && t !== u.length - 1 && (r = l[t - 1],
                n = l[t],
                i = [e],
                o = [r, n],
                s = [t - 1, t],
                gt(e, f.cssClasses.draggable),
                a.fixed && (i.push(r.children[0]),
                i.push(n.children[0])),
                a.dragAll && (o = l,
                s = g),
        ...
        function Z(t, e) {
            ...
            if (l[t].style[f.transformRule] = e,
        ...
        function et(t, e, r, n, i, o) {
            return !1 !== (e = i ? e : G(m, t, e, r, n, !1, o)) && (Z(t, e),
            !0)
        }
        function rt(t) {
            var e, r, n;
            u[t] && (e = m.slice(),
            x && e.sort(function(t, e) {
                return t - e
            }),
            n = 100,
